...
export default function MultiKnightLive() {
    ...
    useEffect(() => {
        ...
        socket.on("game_info", (data: PublicGame<any>) => {
            ...
            let tempGameState = new MultiKnightState(data.gameState.grid, data.gameState.turn);
    ...
    let multiKnightRenderer = <MultiKnightRenderer gameState={gameState} submitter={(move) => {
